...
const apptStatusMap: Record<string, { label: string; cls: string; icon: string }> = {
  ...
  present: { label: 'Presente', cls: 'bg-purple-100 text-purple-700', icon: '🏥' },
  in_attendance: { label: 'Em atendimento', cls: 'bg-emerald-100 text-emerald-700', icon: '🩺' },
  attended: { label: 'Atendido', cls: 'bg-emerald-100 text-emerald-700', icon: '🩺' },
